...
os.environ["DATABASE_URL"] = "sqlite+aiosqlite:///./.pytest_cb.db"
os.environ["API_KEY_READ"] = "test-read-key"
os.environ["API_KEY_WRITE"] = "test-write-key"
os.environ["API_KEY_OPS"] = "test-ops-key"
os.environ["TENANT_KEYS_JSON"] = (
    '[{"tenant_id":"TENANT_A","read":"key-a-read","write":"key-a-write"},'
    '{"tenant_id":"TENANT_B","read":"key-b-read","write":"key-b-write"}]'
)
